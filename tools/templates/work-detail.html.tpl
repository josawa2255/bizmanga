...
<head>
  ...
  <meta property="og:image" content="https://bizmanga.contentsx.jp/material/images/og/og-index.webp">
  ...
  <meta name="twitter:image" content="https://bizmanga.contentsx.jp/material/images/og/og-index.webp">
  <!-- Favicon -->
  ...
  <style>
    ...
    .bm-work-detail-back { display: inline-block; margin-top: 40px; padding: 12px 32px; background: #222; color: #fff; text-decoration: none; border-radius: 999px; font-size: 14px; font-weight: 700; }
    .bm-work-detail-back:hover { background: #e91e63; }
    .bm-work-detail-cta { margin-top: 60px; padding: 40px; background: linear-gradient(135deg, #fff5f8, #fff); border-radius: 16px; text-align: center; }
    .bm-work-detail-cta h3 { font-size: 22px; margin: 0 0 12px; }
    .bm-work-detail-cta p { font-size: 14px; color: #666; margin: 0 0 20px; }
    .bm-work-detail-cta a { display: inline-block; padding: 14px 40px; background: #e91e63; color: #fff; text-decoration: none; border-radius: 999px; font-weight: 700; }
  </style>
    ...
    <div class="bm-container">
      ...
      <header class="bm-work-detail-hero">
        ...
        <div class="bm-work-detail-thumb">
          <img src="{{thumbnail}}" alt="{{title_ja}}" width="1200" height="630">
        </div>
      </header>
